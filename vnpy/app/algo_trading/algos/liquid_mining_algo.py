    ...
    def on_timer(self):
        ...
        if self.vt_ask_orderid == "":
            ...
            if total_ask_volume != self.last_ask_volume:
                ...
                if self.last_ask_price == 0.00000001 or ((vt_ask_price > self.last_ask_price * 0.95) and (vt_ask_price < self.last_ask_price * 1.055)):
        ...
        if self.vt_bid_orderid == "":
            ...
            if total_bid_volume != self.last_bid_volume:
                ...
                if self.last_bid_price == 0.00000001 or ((vt_bid_price > self.last_bid_price * 0.95) and (vt_bid_price < self.last_bid_price * 1.055)):
